...
/*****************************************************************************
 * Ant(int, int, int, int)
 * Description: Initializes the board based on user inputs--which are passed
...
/*******************************************************************************
 * makeMove()
 * Description: Function that "looks ahead" before the ant moves. The current
...
/*******************************************************************************
 * moveAnt()
 * Description: Moves the ant to the new location. Border boundaries have already
...
/*******************************************************************************
 * deleteBoard()
 * Description: Deallocates the game board.
*******************************************************************************/
